...
from llm_calls.anthro_llm import AnthropicLLM
# We no longer need PromptManager for this test script
...
"""
        ...
        print("\n--- Step 1: Generating Python code via Anthropic LLM ---")
        try:
            llm_client = AnthropicLLM()
            # Pass the generated prompts to the LLM
            generated_script = llm_client.call_anthropic_llm(system_prompt, user_prompt)
...
if __name__ == "__main__":
    # This requires ANTHROPIC_API_KEY to be set in your .env file
